...
public class Rectangle {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            Scanner scn = new Scanner(System.in); // inicializácia "konzoly" pre používateľský vstup
            ...
            odpoved = scn.nextLine(); // premenná odpoveď bude obsahovať písmeno (možnosť), ktoré zadal používateľ
